        ...
        <div className="box-design banner-ls xl:flex justify-center">
            <div className='xl:flex'>
                <div className='my-auto w-100 xl:w-50  mx-auto '>
                    <div className=''>
                        <h1 className='text-uppercase text-white text-center text-3xl pt-5'>Please <span className='text-color '>Give your feedback!</span></h1>
                    ...
                    <div className='flex justify-center mt-5'>
                        <div className="d-from">
                            <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col">
                                <input className='w-100' type="text" placeholder='Enter your name' {...register("customerName")} value={user.displayName} /> <br />
