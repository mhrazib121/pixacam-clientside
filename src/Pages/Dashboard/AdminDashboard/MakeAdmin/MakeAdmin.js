        ...
        <div className="box-design banner-ls xl:flex justify-center">
            <div className='xl:flex'>
                <div className='my-auto w-100 xl:w-50  mx-auto '>
                    <div className=''>
                        <h1 className='text-uppercase text-white text-center text-3xl pt-5'>Please <span className='text-color '>Make admin!</span></h1>
                    ...
                    <div className='flex justify-center mt-5'>
                        <div className="d-from">
                            <form onSubmit={handleSubmit(onSubmit)}>
                                <input className="w-100 p-2" type="email" placeholder="Enter Email address" {...register("email")} />
                                <br />
