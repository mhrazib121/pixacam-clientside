        ...
        <div className="box-design banner-ls xl:flex justify-center">
            <div className='xl:flex'>
                <div className='my-auto w-100 xl:w-50  mx-auto '>
                    <div className=''>
                        <h1 className='text-uppercase text-white text-center text-3xl pt-5'> <span className='text-color '>Add New product!</span></h1>
                    ...
                    <div className='flex justify-center mt-5'>
                        <div className="d-from">
                            <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col">
                                <input className='w-100 mt-3' type="text" {...register("productName")} placeholder=" Enter Your Service Name" /> <br />
                                <input className='w-100' type='text' {...register("description")} placeholder="Enter Description" /> <br />
                                <input className='w-100' type='text' {...register("img")} placeholder="Image" /> <br />
                                <input className='w-100' type='number' {...register("price")} placeholder="Price" /> <br />
