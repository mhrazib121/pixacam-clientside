...
const Footer = () => {
    return (
        <div className=' p-5  footer '>
            ...
            <div className=' my-4 p-3 me-auto ms-auto'>
                <h6 className='text-lg font-bold text-color'>Information</h6>
            ...
            <div className='my-4 p-3 me-auto ms-auto'>
                <h6 className='text-lg font-bold text-color'>Get in Touch</h6>
