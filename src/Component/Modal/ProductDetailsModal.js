...
const ProductDetailsModal = ({ productId, setOpenModal }) => {
    ...
    const singlePdcInCard = cardDetails.find(product => product.cart._id === productId);
    ...
    return (
        <div className='modal-container'>
            <div className='modal-content-container bg-gray-100'>
                <FontAwesomeIcon icon={faXmarkCircle} className=" btn-cart absolute right-0 top-2 ms-auto text-2xl me-2 cursor-pointer" onClick={() => setOpenModal(false)} />
                <div className='lg:flex mx-5 my-4 p-3 pb-5 '>
                    <div className='flex'>
                        ...
                        <div className='ms-4'>
                            ...
                            <p className='my-3'>Lorem ipsum, dolor sit amet consectetur adipisicing elit. <br /> Fugiat maiores sapiente maxime harum, <br /> dolorum molestias? Lorem ipsum dolor sit amet, </p>
                            <button className='btn-all mx-2' onClick={() => addToCard(productDetails)}>  Add to card  </button>
                        </div>
                    </div>
